...
public class DentakuFrame2 extends JFrame {
	...
	public DentakuFrame2() {
		...
		keyPanel.add(new AllClearButton(),16);
		keyPanel.add(new ClearButton(),17);
		keyPanel.add(new PlusMinusButton("±"), 18);
		keyPanel.add(new SqrtButton("√"), 19);
